      ...
      <div className="flex flex-wrap gap-4">
        {technologies.map((tech, index) => (
          <div key={index} className="relative group">
            ...
            <div className="relative bg-purple-400/40 text-purple-800 dark:bg-purple-500/10 dark:text-purple-100 border border-slate-200 dark:border-white/10 rounded-xl p-4 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <Image
                src={tech}
