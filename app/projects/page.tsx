...
function MyProjects() {
  return (
    <div className="min-h-screen flex flex-col items-center pt-20 pb-10 bg-white dark:bg-[linear-gradient(90deg,rgba(4,7,29,1)_0%,rgba(12,14,35,1)_100%)] text-gray-900 dark:text-white">
